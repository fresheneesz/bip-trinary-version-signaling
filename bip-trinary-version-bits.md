...
This document specifies an alternative to [BIP9](https://github.com/bitcoin/bips/blob/master/bip-0009.mediawiki) that corrects for a number of perceived mistakes. Block heights are used for start and timeout rather than POSIX timestamps. It additionally introduces an activation parameter that can guarantee activation of backward-compatible changes (further called "soft forks").
...
[![img](https://github.com/bitcoin/bips/raw/master/bip-0008/states.png)](https://github.com/bitcoin/bips/blob/master/bip-0008/states.png)
